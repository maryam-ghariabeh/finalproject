...
class HallBScreen extends StatelessWidget {
   HallBScreen({Key? key}) : super(key: key);
...
class _MyHomePageState extends State<MyHomePage> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: Text('''B Hall''',style:TextStyle( fontStyle: FontStyle.italic ,
  color: Colors.white),),
         ...
         Container(
          child:  Expanded(
              ...
              title: SizedBox( width:170.0,  height: 170.0,
                child:Image.asset( 'image/GIP_image/h4.png', fit: BoxFit.fill, ), ),
                subtitle: Text('''    Adress : Amman - P street - inside Four 
                Season Hotel , in level 1''',style:TextStyle( fontStyle: FontStyle.italic  ,color: Colors.black, fontSize: 20,height: 1.50,),),), ), ),
/*---------*/
 /*Row(
            children: [
